...
private:
    ...
    /**
     * @return index of last unused MyByte
     */
    ...
    private:
        ...
        const BitArray<blockType> *bitArray;
    ...
    public:
        ...
        Bit(const BitArray<blockType> *bitArray, int ind);
...
public:
    ...
    bool get(int ind) const {
        if (ind < 0 || ind >= currSizeInBites) {
            throw std::out_of_range("invalid index");
        } else {
            int byteNum = ind / 8;
            int bitNum = ind % 8;
            return (*((MyByte *) this->array + byteNum)) & (1 << (7 - bitNum));
        }
    }
     ...
     */
    void set(int n, bool val = true) const;
    ...
    //turn every MyByte to char, returns string of this chars
